...
class MAS():
    ...
    def forward(self, taskInfo):
        """
        A multi-agent system for solving math problems involving complex numerical calculations.
        Steps:
            1. 3 agents independently solves the problem by breaking it down into steps and generating code.
            2. Each agent organizes the solution based on the code execution results, ensuring clarity and correctness.
            3. A final agent evaluates all the solutions and determines the final solution.
        """
        # The number of agents to generate solutions for diversity
        agent_num = 3
        solutions = []
        for _ in range(agent_num):
            # Generate code and get output of the code execution
