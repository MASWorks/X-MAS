...
for i, test_dataset_name in enumerate(args.test_dataset_names):
    ...
    try:
        ...
        print(f">> Processing evaluate {i}-th dataset: {test_dataset_name}")

        # ================== Define the output files ==================
        output_logging = f"XMAS-Bench/results/{test_dataset_name}/log/{args.model_name}_evaluate.txt"
        output_json = f"XMAS-Bench/results/{test_dataset_name}/{args.model_name}_evaluate.jsonl"
